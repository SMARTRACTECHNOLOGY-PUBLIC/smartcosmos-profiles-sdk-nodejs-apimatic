...
/**
 * Creates an instance of ValidateOTPEncryptionResultResponseModel
 *
 * @constructor
 */
ValidateOTPEncryptionResultResponseModel = function (obj) {
    if(!obj) {
        this.code = null;     
        this.message = null;     
        this.tagId = null;     
...
module.exports = ValidateOTPEncryptionResultResponseModel;
